/// \file procctrl-create-group.cc
/*
 *
 * procctrl-create-group.cc source template automatically generated by a class generator
...
int main(int argc, char **argv)
{
  ...
  db.createNewGroup(group, groupPassword);

  std::cout << "Successfully created group '" << group << "' !" << std::endl;
