/// \file procctrl-check-group-pwd.cc
/*
 *
 * procctrl-check-group-password.cc source template automatically generated by a class generator
...
int main(int argc, char **argv)
{
  ...
  if(db.checkGroupPassword(group, groupPassword))
  {
